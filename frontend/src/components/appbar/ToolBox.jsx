...
export function ToolBox({
  ...
  return (
    <div className="tools-section tool-box" hidden={hidden}>
      <button
      ...
      <select
        name="strokesize"
        id="strokesize"
        className="hamburger text-md font-semibold"
        value={strokesize}
      ...
      >
        ...
        <option value="10" className="options">
          10
        </option>
        <option value="15" className="options">
          15
        </option>
        <option value="20" className="options">
          20
        </option>
        <option value="30" className="options">
          30
        </option>
      </select>
    </div>
